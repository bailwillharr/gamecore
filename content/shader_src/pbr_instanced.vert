...
void main() {
    ...
    mat3 normal_matrix = transpose(inverse(mat3(world_transform)));
    ...
    vout.position = vec3(world_transform * vec4(in_position, 1.0));
    ...
    gl_Position = pc.projection * pc.view * world_transform * vec4(in_position, 1.0);
}
